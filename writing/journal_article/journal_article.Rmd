...
```
```{r analyze-reps, fig.width=3.4, fig.height = 5.4, fig.cap = "Density plots showing children's use of atypical and typical adjective-noun pairs across age after excluding repeated utterances.", fig.pos="tb"}
