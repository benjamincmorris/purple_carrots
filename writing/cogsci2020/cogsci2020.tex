...
young children may either have warped estimates of typical features for
categories they learn about through language or use other information to
acquire adult-like understanding of typicality.
...
broad features of this typicality distribution and the way it changed
over development.
...
privileges redundant information, perhaps to align to young children's
limited world knowledge, caregiver description should yield a distinct
distribution dominated by highly typical modifiers. We find that
parents' description predominantly focuses on features that atypical of
the concept (Figure \ref{fig:distribution_plot}).
...
intercept was reliably negative, indicating that adult-directed speech
...
point out atypical features (as in adult-directed speech), this effect
...
set of 21 distinct adjective-noun pairs which also appeared in
...
similarity judgments within part of speech categories (correlation with
wordsim353 similarities between noun pairs, 0.28; correlation with
simlex similarities within noun, adjective, and verb pairs, 0.16). This
suggests that statistical patterns in child-directed speech are likely
insufficient to encode information about the typical features of
objects, despite encoding at least some information about word meaning
more broadly.
...
models were more highly correlated than either model's similarity and
human judgments (\(r =\) 0.29, \(p\) \textless{} .001). This suggests
that these models are picking up on some systematic associations between
nouns and adjectives, but not typicality information.
...
performed a second analysis where we considered only the subset of 73
...
similar than the high-typicality.
...
puzzle & flat & giant \\ 
  ...
  frog & green & purple \\ 
   \hline
\end{tabular}
\caption{This table shows the six cases in which word2vec similarities are worst at predicting human typicality judgments, judging the low-typicality adjective to be more similar to the noun than the high-typicality adjective.} 
\label{tab:pairs_tab}
\end{table}
...
around them. Indeed, such findings are consistent with our data that
even young children largely choose to describe atypical features. Though
this effect can be explained by simpler means such as mimicry, it
suggests that caregivers and children may be usefully aligned in the
aspects of the world they choose to talk about.
