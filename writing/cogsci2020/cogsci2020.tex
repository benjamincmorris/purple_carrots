...
world. However, language does not perfectly reflect the world: what is
typical may often go unremarked. For instance, adults rarely describe
the color of an orange carrot, as world knowledge makes this description
redundant. Given children's nascent world knowledge, does parents'
speech to children follow this pattern? From a longitudinal corpus of
parent-child communication (Goldin-Meadow et al., 2014) between 14--58
months, we extracted usage data for 637 high-frequency concrete nouns
and co-occurring adjectives. Independent raters coded the typicality of
1,901 unique adjective--noun pairs on a 7-point Likert scale. We find
that parent language highlights the atypical features of things, across
all child ages. Parents were reliably more likely to use typical
descriptors when talking to younger compared to older children. Using
vector space models trained on our corpus and on Wikipedia, we show that
rich typicality information remains difficult to extract from language
alone.\\
